...
public class Book {
	...
	public enum Topic {
		PROGRAMMING, FICTION, SHORT, HUMOR, DETECTIVE
	}
	...
	static void createLibrary() {
		...
		Book b2 = new Book("Tom Sawyer", new int[] { 300 }, 20.5, 
				Topic.FICTION, Arrays.asList("Mark Twain"), Year.of(1930));
	...
	public String toString() {
		return "Book [title=" + title + ", pageCounts=" + Arrays.toString(pageCounts) + ", height=" + height
				+ ", topic=" + topic + ", authors=" + authors + ", year=" + year + "]";
	}
