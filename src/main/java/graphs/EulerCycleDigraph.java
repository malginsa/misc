...
class EulerCycleDigraph {
    ...
    private static class DiGraph {
        ...
        // diGraph creation using data from input stream
        public DiGraph() {
        ...
        // diGraph creation using data from input file
    ...
    private static class Cycle {
        ...
        private final int START_VERTEX = DiGraph.FIRST_INDEX;
        ...
        public String getEulerCycle() {
            ...
            for (int vertex = DiGraph.FIRST_INDEX; vertex < diGraph.getV() + DiGraph.FIRST_INDEX; vertex++) {
                adjacenciesCount = 0;
                for (Integer degree : diGraph.getAdjacencies(vertex).values()) {
            ...
            while (!candidates.isEmpty()) {
                ...
                if (diGraph.getAdjacencies(candidate).size() != 0) {
        ...
        private List<Integer> findCycle(int start) {
            ...
            vertexOpt = diGraph.pullAnyAdjacency(vertex);
