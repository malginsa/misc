...
public class RectanglesTest
{
    ...
    public void treePoints()
    {
        ...
        assertEquals(0, Calculator.optimized(points));
    }
    ...
    public void oneRectangle()
    {
        ...
        assertEquals(1, Calculator.optimized(points));
    }
    ...
    public void twoRectangles()
    {
        ...
        assertEquals(2, Calculator.optimized(points));
    }
    ...
    public void threeOverlappingRectangles()
    {
        ...
        assertEquals(3, Calculator.optimized(points));
    }
    ...
    public void nineOverlappingRectangles()
    {
        ...
        assertEquals(9, Calculator.optimized(points));
    }
    ...
    public static void testPredefinedSetNxN(int xSize, int ySize, int countOfExpectedRectangles) throws IOException
    {
        ...
        assertEquals(countOfExpectedRectangles, Calculator.optimized(points));
    }
}